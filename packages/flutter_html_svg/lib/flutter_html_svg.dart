          ...
          builder: (buildContext) {
            return GestureDetector(
              ...
              onTap: () {
                ...
                context.parser.onImageTap?.call(context.tree.element?.outerHtml ?? "", context, context.tree.element!.attributes.cast(), context.tree.element);
              },
            );
          });
    });
          ...
          builder: (buildContext) {
            return GestureDetector(
              ...
              onTap: () {
                ...
                context.parser.onImageTap?.call(Uri.decodeFull(data), context, context.tree.element!.attributes.cast(), context.tree.element);
              },
            );
          });
    });
          ...
          builder: (buildContext) {
            return GestureDetector(
              ...
              onTap: () {
                ...
                context.parser.onImageTap?.call(context.tree.element!.attributes["src"]!, context, context.tree.element!.attributes.cast(), context.tree.element);
              },
            );
          });
    });
  ...
  String? extension = "svg",
    ...
    (context) {
      ...
      try {
        ...
        return context.tree.element?.localName == "img" && schemas.contains(src.scheme) && (domains == null || domains.contains(src.host)) && (extension == null || src.path.endsWith(".$extension"));
      } catch (e) {
        return false;
      }
    };
