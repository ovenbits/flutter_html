...
CustomRenderMatcher blockElementMatcher() => (context) {
      return (context.tree.style.display == Display.block || context.tree.style.display == Display.inlineBlock) && (context.tree.children.isNotEmpty || context.tree.element?.localName == "hr");
    };
          ...
          children: (children as List<TextSpan>?) ??
              context.tree.children
                  .expandIndexed((i, childTree) => [
                        ...
                        if (i != context.tree.children.length - 1 && childTree.style.display == Display.block && childTree.element?.localName != "html" && childTree.element?.localName != "body") const TextSpan(text: "\n"),
                      ])
                  .toList(),
        );
      }
    ...
    inlineSpan: (context, buildChildren) => TextSpan(
          ...
          children: context.tree.children
              .expand((tree) => [
                    ...
                    if (tree.style.display == Display.block && tree.element?.parent?.localName != "th" && tree.element?.parent?.localName != "td" && tree.element?.localName != "html" && tree.element?.localName != "body") const TextSpan(text: "\n"),
                  ])
              .toList(),
        ));
